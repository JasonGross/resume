...
DEPENDENCIES = $(GENERIC_STY) $(GENERIC_TEX) $(ALL_DTX_INS_STY) $(ALL_TEX_INS_STY) $(ALL_TEX_INS_STY) $(INS_STY) $(ALL_DTX_STY) $(ALL_DTX_LATEX_STY) $(SIMPLE_DEPENDENCIES) $(SIMPLE_TEX) $(SIMPLE_DEFS) $(OBERDIEK_DTX_STY) $(UNIS) $(REQUIRED_GRAPHICS_DTX_INS_STY) $(NORMAL_ZIPS:.zip=.sty) article.cls hyperref.sty #graphics.sty verbatim.sty etex.sty fontenc.sty # utf8x.def ucsencs.def uni-34.def uni-33.def uni-3.def uni-32.def uni-37.def uni-35.def uni-0.def uni-32.def uni-39.def tipa.sty uni-29.def uni-37.def uni-2.def uni-3.def cmap.sty mmap.sty
