...
\begin{multitex}
  ...
  \begin{position}
    \begin{itemize}
      \item Entered a significant amount of category theory into the automated proof assistant Coq (\url{https://bitbucket.org/JasonGross/catdb} and \url{https://github.com/JasonGross/HoTT-categories})
...
\begin{multitex}
    \begin{itemize}
      ...
      \item Co-maintainer of the formalization of homotopy type theory in Coq (\url{https://github.com/HoTT/HoTT})
      }
    \end{itemize}
