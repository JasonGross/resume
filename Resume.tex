...
\begin{multitex*}[\cvfiles]%
		...
		\begin{itemize}
			...
			\item Physics: Statistical Mechanics I (Graduate, in progress), General Relativity (Graduate), Statistical Physics I \& II, Quantum Physics I, II, \& III, Classical Mechanics II, Waves and Vibrations, Special Relativity and the Physics of Spacetime
...
\begin{multitex}
    \begin{itemize}
      ...
      \item
        Basic knowledge -- Matlab, OCaml, Idris, Ruby, Ur/Web, x86 Assembly
    \end{itemize}
\end{multitex}
