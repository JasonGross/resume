...
\begin{multitex}
  ...
  \def\cvshortfiles{curriculum-vitae,curriculum-vitae-mathematics,curriculum-vitae-computer-science}
  \def\cvlongfiles{curriculum-vitae-long}
  ...
  \def\computersciencefiles{computer-science,curriculum-vitae-computer-science}
...
\begin{multitex}[\allexceptcvlongfiles]
  \name{\LARGE \bf \parbox{\widthof{Jason Gross}}{%
...
\begin{multitex}[\allexceptcvlongfiles]
  ...
  Programming Languages, Formal Verification, Performance of Automation in Interactive Proof Assistants, Homotopy Type Theory, Category Theory, Program Synthesis, Cryptography

  \section {\textsc{Primary Contributions}}
  Fiat Cryptography
  \begin{itemize}
    \item Collaboratively working on  one of the world's first algorithm-level-optimizing compilers
  ...
  \begin{itemize}
    ...
    \item Reporting the plurality of bugs in the proof assistant Coq
  \end{itemize}
\end{multitex}
...
\begin{multitex}[\allexceptcvlongfiles]
  ...
  \begin{position}\\
    ...
    \textit{MA Thesis: An Extensible Framework for Synthesizing Efficient, Verified Parsers}
  \end{position}
...
\begin{multitex*}[\cvfiles]
    ...
    \begin{position}
        \begin{itemize}
            ...
            \onlymultitex{\cvfiles}{\item Made progress towards an interface for databases and database migration on top of category theory in Coq with David Spivak and Adam Chlipala}
...
\begin{multitex*}[\cvfiles]
  ...
  \begin{position}
    \begin{itemize}
      \onlymultitex*{\cvfiles}{\item Designed from scratch a data collection webpage, collected data for, and helped with research \onlymultitex*{\cvfiles}{ of Brenden Lake, Ruslan Salakhutdinov, and Josh Tenenbaum, }on categorical and transfer learning\onlymultitex*{\cvlongfiles}{ (\url{https://jgross.scripts.mit.edu/alphabets/})}.}
...
\begin{multitex}
    \begin{itemize}
      \item
        Proficient skills -- Coq, \onlymultitex*{\cvlongfiles}{\TeX{} macro language, }Mathematica, git, Python, JavaScript, BASIC
      \item
        Working knowledge -- \onlymultitex*{\cvlongfiles}{\LaTeX{}, }C, C++, Agda, OCaml, Haskell, Scheme, HTML, CSS, Perl, Java
      \item
        Basic knowledge -- Matlab, Idris, Ruby, Ur/Web, x86 Assembly
    \end{itemize}
\end{multitex}
...
\begin{multitex}
  ...
  \begin{itemize}
  \item Instructor at Monsoon Math: Classes on category theory, linear logic, and L\"ob's theorem
  ...
  \item Volunteer for MIT ESP: Classes on \LaTeX, philosophy, linear algebra, and quantum mechanics
  \end{itemize}
\end{multitex}
