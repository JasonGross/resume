...
\begin{multitex*}[\cvfiles]
  ...
  \begin{position}
    \begin{itemize}
      \onlymultitex*{\cvfiles}{\item Designed from scratch a data collection webpage, collected data for, and helped with research \onlymultitex*{\cvfiles}{ of Brenden Lake, Ruslan Salakhutdinov, and Josh Tenenbaum, }on categorical and transfer learning (\url{https://jgross.scripts.mit.edu/alphabets/}).}
