...
\section{\textsc{Education}}
    ...
    Beginning Doctorate of Philosophy in Computer Science in September 2013 \\
    \\
...
\begin{multitex}[\resumefiles]%
    Relevant Coursework: Performance Engineering of Software Systems, Statistical Physics, Quantum Physics, Topology, Analysis, Waves \& Vibrations, Special Relativity% and the Physics of Spacetime%
		, Algebra
\end{multitex}
\begin{multitex*}[\cvfiles]%
		...
		\begin{itemize}
			...
			\item Mathematics: Paradox and Infinity (current), Category Theory for Scientists (current), Algebraic Topology I, Seminar in Topology, Introduction to Topology, Real Analysis, Abstract Algebra I \& II, Differential Equations, Calculus I \& II, Linear Algebra
			\item Other Sciences: Performance Engineering of Software Systems, Structure and Interpretation of Computer Programs, Introductory Biology, Introductory Chemistry, Design a Concentrated Solar Power Water Heater (seminar)
			\item Other: The Art and Science of Happiness (current), Metaphysics, Introduction to Musical Composition, Capitalism and Its Critics, Moral Psychology, Philosophy of Quantum Mechanics, Moral Problems and the Good Life, Philosophy of Love
		\end{itemize}
\end{multitex*}
...
\begin{multitex}
    \begin{itemize}
      \item
        Proficient skills -- BASIC, Python, Java, JavaScript, Mathematica, \TeX{} macro language, Coq
      \item
        Working knowledge -- C, C++, Scheme, Haskell, Matlab, HTML, CSS, git, \LaTeX{}
      \item
        Basic knowledge -- Agda, OCaml, Ur/Web
    \end{itemize}
