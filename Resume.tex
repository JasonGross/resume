...
\vspace*{-0.25cm}
Research scientist with extensive experience in proofs and formal verification transitioning to ML and alignment research.
Currently researching mechanistic interpretability, heuristic arguments, and compact proofs. Programming language polyglot, with working knowledge of around two dozen programming languages, and expertise in a handful (Coq (1M+ loc), Python (40k+ loc), Agda (40k+ loc), others).
I spent my PhD on low-level cryptographic code generation, automation, performance engineering, and infrastructure around debugging and CI.
