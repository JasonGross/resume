...
\begin{multitex*}[\cvfiles]%
		...
		\begin{itemize}
			...
			\item Mathematics: Seminar in Logic (current), Paradox and Infinity (current), Category Theory for Scientists (current), Algebraic Topology I, Seminar in Topology, Introduction to Topology, Real Analysis, Abstract Algebra I \& II, Differential Equations, Calculus I \& II, Linear Algebra
