...
\begin{multitex}
  ...
  \begin{itemize}
    ...
    \item Trust and Security Engineering: Scalable Formal Verification, Cryptography, Performance Engineering
  \end{itemize}
  ...
  \item Supervising independent research in formalizing correspondence of affine logic to two-player games
