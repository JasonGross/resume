...
\begin{multitex}
  ...
  \begin{position}
    \begin{itemize}
      \item Entered a significant amount of category theory into the automated proof assistant Coq (\url{https://bitbucket.org/JasonGross/catdb}); later worked on formalizing category theory on top of homotopy type theory (\url{https://github.com/JasonGross/HoTT-categories})
