...
\usepackage[backend=biber,bibencoding=utf-8,maxbibnames=99,sorting=ymdnt,noerroretextools=true]{biblatex}
...
\begin{multitex}
  ...
  \def\cvandmathfiles{mathematics,curriculum-vitae,curriculum-vitae-mathematics,curriculum-vitae-computer-science,curriculum-vitae-long}
  \def\cvandcomputersciencefiles{computer-science,curriculum-vitae,curriculum-vitae-mathematics,curriculum-vitae-computer-science,curriculum-vitae-long}
  ...
  \usepackage[backend=biber,maxbibnames=99,sorting=ymdnt,noerroretextools=true]{biblatex}
% http://tex.stackexchange.com/a/140641
\DeclareSortingTemplate{ymdnt}{
    \sort{
        \field{presort}
...
\begin{multitex}[\cvandmathfiles]
  ...
  \end{position}
\end{multitex}
\begin{multitex*}[\cvandcomputersciencefiles]
  \employer{MIT}
...
\begin{multitex*}[\cvfiles]
  ...
  \begin{position}
    \begin{itemize}
      \onlymultitex*{\cvfiles}{\item Designed from scratch a data collection webpage, collected data for, and helped with research \onlymultitex*{\cvfiles}{ of Brenden Lake, Ruslan Salakhutdinov, and Josh Tenenbaum, }on categorical and transfer learning (\url{http://jgross.scripts.mit.edu/alphabets/}).}
...
\begin{multitex*}[\highschoolfiles,\cvlongfiles]
