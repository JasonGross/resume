...
\begin{multitex*}[\cvfiles]
  ...
  \begin{position}
    \begin{itemize}
      \item Performing self-directed research into topics in basic programming language theory and math%ematics%, bringing insights and understanding back to my supervisor
    \end{itemize}
  \end{position}
  ...
  \begin{position}
    \begin{itemize}
      ...
      \item Collaboratively worked on one of the world's first algorithm-level-optimizing compilers
      ...
      \item Researched performance issues that impact scalability of automated verification
      \item Reported the plurality of bugs in the proof assistant Coq
    \end{itemize}
  \end{position}
...
\begin{multitex}
    \begin{itemize}
      ...
      \item
        Basic knowledge -- Matlab, Lean, Idris, Ruby, Ur/Web, x86 Assembly
    \end{itemize}
\end{multitex}
...
\begin{multitex}
  ...
  \begin{itemize}
  \item Instructor at Monsoon Math Camp: Classes on category theory, linear logic, L\"ob's theorem
  ...
  \item Teacher at MIT ESP Programs: Classes on \LaTeX, philosophy, linear algebra, and quantum mechanics
  \end{itemize}
\end{multitex}
...
\begin{multitex}
    \begin{itemize}
      ...
      \item Co-maintainer of the Fiat Cryptography project (\href{https://github.com/mit-plv/fiat-crypto}{mit-plv/fiat-crypto} on GitHub)
