...
\begin{multitex*}[\cvfiles]%
		Coursework:
		\begin{itemize}
			\item Computer Science: Foundations of Program Analysis, Performance Engineering of Software Systems, Structure and Interpretation of Computer Programs
...
\begin{multitex}
    \begin{itemize}
      ...
      \item
        Working knowledge -- Agda, C, C++, Scheme, Haskell, Matlab, HTML, CSS, git, \LaTeX{}, Perl
      \item
        Basic knowledge -- Idris, OCaml, Ur/Web, Ruby
    \end{itemize}
