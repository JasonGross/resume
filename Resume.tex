...
\section{\textsc{Education}}
    ...
    \\
    %\onlymultitex*{\cvfiles}{\textbf{Massachusetts Institute of Technology}, Cambridge, MA  \\}
    Bachelor of Science, June 2013   \\
    Major in Mathematics and Physics       \\
    %Minors in Computer Science and Economics  \\
    Undergraduate G.P.A. 4.6/5.0 \\
    \\
\end{multitex}
\begin{multitex}[\resumefiles]%
    Relevant Coursework: %Foundations of
        Program Analysis, Performance Engineering of Software% Systems
        , Statistical Physics, Quantum Physics, Topology, Analysis, Waves \& Vibrations, Special Relativity% and the Physics of Spacetime%
        , Algebra
\end{multitex}
\begin{multitex*}[\cvfiles]%
        Coursework:
        \begin{itemize}
            \item Computer Science: Foundations of Program Analysis (current), Performance Engineering of Software Systems, Structure and Interpretation of Computer Programs
...
\begin{multitex}
  ...
  \begin{position}
    \begin{itemize}
      \item Entered a significant amount of category theory into the automated proof assistant Coq (%\url{https://bitbucket.org/JasonGross/catdb} and
        \url{https://github.com/JasonGross/HoTT-categories})
      \item Worked on building an interface for databases and database migration on top of category theory in Coq with David Spivak and Adam Chlipala
    \end{itemize}
  \end{position}
...
\begin{multitex}
    \begin{itemize}
      ...
      \item
        Working knowledge -- Agda, C, C++, Scheme, Haskell, Matlab, HTML, CSS, git, \LaTeX{}
      \item
        Basic knowledge -- OCaml, Ur/Web
    \end{itemize}
...
\begin{multitex}
    \begin{itemize}
      ...
      \onlymultitex*{\cvfiles}{\item HMMT Solutions Editor (2010)}
      ...
      \item Co-maintainer of the homotopy type theory Coq repository (\href{https://github.com/HoTT/HoTT}{\textttt{HoTT/HoTT} on github})
      }
    \end{itemize}
...
\section{\textsc{Interests}}
    \begin{itemize}
      \item Philosophy
      \item Programming
      \item Dancing, especially contra-, square-, and tango dancing
      \item Psychology
      \item Hiking
      %\onlymultitex*{\highschoolfiles}{
