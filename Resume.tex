...
\usepackage{hyperref}
%\addbibresource{personal-website/jason-gross.bib}
...
\newcommand{\multitex@postprocess}[1]{%
  ...
  \ifmultitexcompile
    ...
    \immediate\write18{bibtex \csname @multitex@#1@auxname\endcsname}%
    \immediate\write18{pdflatex \csname @multitex@#1@name\endcsname}%
    \immediate\write18{pdflatex \csname @multitex@#1@name\endcsname}%
  \fi
}
...
\begin{multitex*}[\cvfiles]
  ...
  %\printbibliography[title={\textsc{Presentations and Publications}}]
\end{multitex*}
