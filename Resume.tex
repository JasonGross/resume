...
\begin{multitex}[\resumefiles]%
    Relevant Coursework: Foundations of Program Analysis (current), Performance Engineering of Software Systems, Statistical Physics, Quantum Physics, Topology, Analysis, Waves \& Vibrations, Special Relativity% and the Physics of Spacetime%
		, Algebra
\end{multitex}
...
\begin{multitex}
  ...
  \begin{position}
    \begin{itemize}
      \item Entered a significant amount of category theory into the automated proof assistant Coq \onlymultitex*{\cvfiles}{(\url{https://github.com/JasonGross/HoTT-categories})}
...
\begin{multitex}
    \begin{itemize}
      \item
        Proficient skills -- Coq, Python, Java, JavaScript, Mathematica, \TeX{} macro language, BASIC
      \item
        Working knowledge -- C, C++, Scheme, Haskell, Matlab, HTML, CSS, git, \LaTeX{}, Agda
      \item
        Basic knowledge -- Idris, OCaml, Ur/Web
    \end{itemize}
