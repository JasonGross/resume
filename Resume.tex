...
\begin{multitex}[\resumefiles]%
    Relevant Coursework: Statistical Physics I, Quantum Physics I \& II, Intro to Topology, Real Analysis, Waves and Vibrations, Special Relativity% and the Physics of Spacetime%
		, Abstract Algebra I \& II
\end{multitex}
\begin{multitex*}[\cvfiles]%
		Coursework:
		\begin{itemize}
			\item Physics: Quantum Physics III (current), Statistical Physics II (current), Statistical Physics I, Quantum Physics I \& II, Classical Mechanics II, Waves and Vibrations, Special Relativity and the Physics of Spacetime
			\item Mathematics: Seminar in Topology (current), Introduction to Topology, Real Analysis, Abstract Algebra I \& II, Differential Equations, Calculus I \& II, Linear Algebra
			...
			\item Other: Introduction to Musical Composition (current), Capitalism and Its Critics, Moral Psychology, Pilosophy of Quantum Mechanics, Moral Problems and the Good Life, Philosophy of Love
		\end{itemize}
\end{multitex*}
...
\begin{multitex}
    \begin{itemize}
      ...
      \item Working knowledge -- Scheme, Haskell, Matlab, HTML, CSS, git, \LaTeX{}
